...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        <ul>
            ...
            <li>
                <a href="#" class="alert in-active"><span class="las la-location-arrow"></span><span>Alert</span></a>
            </li>
            <li>
...
<script>
    $(document).ready(function() {
        $('.sidebar-menu ul li .alert').click(function() {
            $('main .content').removeClass('active'); //Remove active class from all tags
            $('main .content').addClass('in-active'); // ADD CLASS TO ALL THE TAGS.

            if ($('main .alertpage').hasClass('in-active')) { // CHECK IF THE TAG HAS 'in-active' CLASS.   
                $('main .alertpage')
                    .removeClass('in-active')
                    .addClass('active');
            }
